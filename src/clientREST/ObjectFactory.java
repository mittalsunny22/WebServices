 ...
 * generated in the clientREST package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeamResponse_QNAME = new QName("http://sunnyREST/", "getTeamResponse");
    private final static QName _GetTeam_QNAME = new QName("http://sunnyREST/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://sunnyREST/", "getTeams");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://sunnyREST/", "getTeamsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: clientREST
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sunnyREST/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sunnyREST/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sunnyREST/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sunnyREST/", name = "getTeamsResponse")
